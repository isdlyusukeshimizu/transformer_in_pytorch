...
Original file is located at
    https://colab.research.google.com/drive/1HY-TCAQdd6iSK93kp8ISXEIY8ro4xJsI
"""
...
df = pd.read_excel("/content/drive/MyDrive/wevnal/transformer_pytorch/dataset/JEC_basic_sentence_v1-3.xls", header = None)
